...
if __name__ == "__main__":
    ...
    # shared.plot_pca(X_scaled=dados['resultado'], labels=kmeans_labels, file_name="results/"+qtd+"/"+qtd+"_kmeans_graph_environment.png", title=title)
    # if results_all[1] != None:  
    ...
    #     shared.plot_pca(X_scaled=dados['resultado'], labels=params_dbscan[3], file_name="results/"+qtd+"/"+qtd+"_dbscan_graph_environment.png",title=title)
